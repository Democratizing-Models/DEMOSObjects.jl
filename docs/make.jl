...
DocMeta.setdocmeta!(DEMOSObjects, :DocTestSetup, :(using DEMOSObjects); recursive = true)
...
makedocs(;
    modules = [DEMOSObjects],
    authors = "Anton Reinhard <a.reinhard@hzdr.de>",
    repo = "https://github.com/Democratizing-Models/DEMOSObjects.jl/blob/{commit}{path}#{line}",
    sitename = "DEMOSObjects.jl",
    format = Documenter.HTML(; canonical = "https://Democratizing-Models.github.io/DEMOSObjects.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/Democratizing-Models/DEMOSObjects.jl")
